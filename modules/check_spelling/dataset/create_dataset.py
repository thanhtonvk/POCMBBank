...
import itertools
import sys
sys.path.append("../Spelling_Correction_Vietnamese")
from modules.params import MAXLEN, NGRAM
import numpy as np
...
if __name__ == "__main__":
    ...
    creater = CreateDataset(csv_path='../Spelling_Correction_Vietnamese/data/samples_sentence.csv', save_path="../Spelling_Correction_Vietnamese/data/list_ngrams.npy")
    creater.processing()
